...
@section('title','DT-SHOP  || Brand Page')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Danh sách nhãn hiệu</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">No brands found!!! Please create Nhãn hàng</h6>
        @endif
      </div>
    </div>
</div>
