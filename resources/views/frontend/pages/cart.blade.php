								...
								@else
										<tr>
											<td class="text-center">
												Bạn không có sản phẩm nào trong giỏ <a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục mua sắm</a>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Tổng giá<span>{{number_format(Helper::totalCartPrice())}} VND</span></li>

										@if(session()->has('coupon'))
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Áp dụng<span>{{number_format(Session::get('coupon')['value'])}} VND</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Phải trả<span>{{number_format($total_amount)}} VND</span></li>
										@else
											<li class="last" id="order_total_price">Phải trả<span>{{number_format($total_amount)}} VND</span></li>
										@endif
									</ul>
