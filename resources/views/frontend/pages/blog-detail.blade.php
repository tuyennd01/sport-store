                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>Viết bởi {{$post->author_info['name']}}</a><a
                                                href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a
                                                href="javascript:void(0);"><i class="fa fa-comments"></i>Bình luận ({{$post->allComments->count()}})</a></span>
                                    </div>
                                    <div class="content">
                                        @if($post->quote)
                                ...
                                <div class="col-12 mt-4">
                                    <div class="reply">
                                        <div class="reply-head comment-form" id="commentFormContainer">
                                            <h2 class="reply-title">Hãy bình luận về bài viết</h2>
                                            <!-- Comment Form -->
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group button">
                                                            <button type="submit" class="btn"><span
                                                                    ...
                                                                    class="comment_btn reply" style="display: none;">Trả lời</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            @else
                                <p class="text-center p-5">
                                    Bạn cần <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng
                                        nhập</a> HOẶC <a style="color:blue" href="{{route('register.form')}}">Đăng
                                        ký</a> để bình luận
